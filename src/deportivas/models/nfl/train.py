"""NFL moneyline: thin wiring of the shared moneyline pipeline
(``models/moneyline_training.py``) over ``nfl_v1`` features. Spread and
...
def compute_and_write_nfl_moneyline_model(
    competition_id: str,
    *,
    ...
    return compute_and_write_moneyline_model(
        competition_id,
        sport=Sport.AMERICAN_FOOTBALL.value,
