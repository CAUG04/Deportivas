"""NBA moneyline: thin wiring of the shared moneyline pipeline
(``models/moneyline_training.py``) over ``nba_v1`` features. Spread and
...
FEATURE_SET = "nba_v1"
MODEL_NAME_PREFIX = "nba_moneyline"


def compute_and_write_nba_moneyline_model(
    competition_id: str,
    *,
